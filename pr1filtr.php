	...
	}else
	{
		...
		else
		{
			...
			if(isset($_POST['btn1'])){
				...
				$sql_z2="SELECT * FROM zastepstwa_historia WHERE id_uzytkownika='$id_uzytkownika' AND data2='$data' AND((zakogo='$idPracownika' AND zakogoPrzedr='pracownik') OR (kto='$idPracownika' AND ktoPrzedr='pracownik')) ORDER BY zastepstwa_historia.dataMysql";
			...
			if(isset($_POST['szukajwhistorii']))
				{
						...
						$sqlsearch = "SELECT id FROM zastepstwa_historia WHERE id_uzytkownika='$id_uzytkownika' AND data2='$data' AND((zakogo='$idPracownika' AND zakogoPrzedr='pracownik') OR (kto='$idPracownika' AND ktoPrzedr='pracownik'))";
						...
						if($rezultquestion=$polaczenie->query($sqlsearch))
							{
								...
								}else
								{
									...
									<input type='hidden' name='inputIdPr1' value='".$idPracownika."'>
		   ...
		   <div class="boxzastepstw">
			   ...
			   <table class='table' id='sortable'>
					<tr>
						...
						<th>
							<?php
							 echo "<form method='post'><input type='hidden' name='idPrSzuk' value='".$idPracownika."'><input type='hidden' name='datahidden' value='".$data."'><input type='hidden' name='monthhidden' value='".$month."'><input type='hidden' name='yearhidden' value='".$year."'><input type='submit' name='btn1' class='button1segr' value='data [dz.mies.]'></form>"; 
							 ?>
						</th>
			...
			<div>
			<?php
				echo "<form action='pr1.php' method='post'>
				<input type='hidden' name='inputIdPr1' value='".$idPracownika."'>
