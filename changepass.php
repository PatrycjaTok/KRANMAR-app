						...
						if($rezult1=$polaczenie->query("UPDATE uzytkownicy SET COD='$cod' WHERE mail='$email'")) // wysłanie zapytania
						 {  
							 ...
							 if($mail->Send()){
								 ...
								 <br><button class='btnEdit positionCentre2'><a href='index.php'>wróć do strony głównej</a></button>";
							 }else{
...
<head>
    ...
    <title>Aplikacja do zarządzania ludźmi - zmiana hasła </title>
    </head>
<body>
    <div class="container">
        <div class="box1">
	   ...
	   <br><button class='btnEditAnuluj'><a href='index.php'>wróć do strony głównej</a></button>
