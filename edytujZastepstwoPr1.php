<?php
	...
	else
	{
		...
		if(isset($_POST['inputIdPr1'])){
			$idPracownika=$_POST['inputIdPr1'];
		}else if(isset($_POST['inputIdRP1'])){
			$idRandom=$_POST['inputIdRP1'];
		};
			...
			<br> 
				<table>
					...
					<?php 
							...
							echo "<form action ='editZastepstwoPr1.php' method='post'><tr>
							...
							if(isset($_POST['inputIdPr1'])){
								echo "<input type='hidden' value='".$idPracownika."' name='idPr1'>";
							}else if(isset($_POST['inputIdRP1'])){
								echo "<input type='hidden' value='".$idRandom."' name='idRP1'>";
							};
