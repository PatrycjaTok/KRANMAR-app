	...
	}else
	{
		...
		//Poniżej - przetważanie naszego formularza:
					...
					else
					{
						...
						$id_pracownika=$_GET['zmiennaId'];
						$id_uzytkownika=$_SESSION['id_uzytkownika'];
						$sql1="SELECT pracownicy.imie, pracownicy.nazwisko FROM pracownicy WHERE id_uzytkownika='$id_uzytkownika' AND id='$id_pracownika'";
						...
						//usuwanie Pracownika
						if(isset($_POST['del'])){
							$sql1="DELETE FROM pracownicy WHERE id='$id_pracownika'";
							if($rezult=$polaczenie->query($sql1))						
							{
...
<html lang="pl-PL">
	...
	<body>
		...
		<div class='okienko'> <form method='post'> Czy na pewno chcesz usunąć pracownika:<br><b>

		<?php
		echo " ".$row['imie']." ".$row['nazwisko']."</b>? <br> <input type='hidden' name='idPracownika' value='".$id_pracownika."'>";			
		?>
