<?php
	...
	else
	{
		...
		$sql1="SELECT firmy.id, firmy.nazwa_firmy FROM firmy WHERE id_uzytkownika='$id_uzytkownika' ORDER BY firmy.nazwa_firmy";
...
<head>
	...
	<link rel="stylesheet" href="css/style3_firmy.css" type="text/css">
    <link rel="icon" href="images/favicon.png" type="image/x-icon">
    <title>Aplikacja do zarządzania ludźmi - firmy</title>
	</head>
<body>
    <div class="container">
	<div class="navbar1">
			...
			<div class='editionbarNAV'>
				<div class='wrapperNAV'> 
					...
					<ul>
						...
						<li><a href="firmy.php" id='currentLink'>firmy</a></li>
					...
					<li> <div class='editionbarNAV'>
						<div class='wrapperNAV'> 
							...
							<ul id='ulSmallHide1' class='secondSt'>
								<li><a href="pracownicy.php">pracownicy</a></li>
								<li><a href="#" id='currentLink'>firmy</a></li>
								<li><a href="randomPeop.php">pozostali</a></li>
							</ul>
						</div>
					</div> </li>
		...
		<div class=box1>
			...
			<div class="boxTitle"> 
					<p>FIRMY <br>
					<input type="text" id="szukaj_pr_input" placeholder='szukaj firmę' class='input_szukaj' onKeyUp='updateSqlAskFirmy()'>	</p>			   
			</div>
		   ...
		   <div class="boxpracownicy">
			   <div class='divAll'>
				...
				<button class='button1 radious5px pointer' onclick="okienko2()">dodaj firmę </button>
				<div class='comm'>
				<?php
				...
				<table>
					...
					<?php
						...
						while($row=$rezult->fetch_assoc())
						{
							...
							echo "<tr>
							<td>".$nr."</td>
							<td><form action='firma1.php' method='post'><input type='hidden' value=".$id_firmy." name='inputIdfirmy1'><input type ='submit' name='zobaczFirme' value='".$row['nazwa_firmy']."' class='btnzobacz pointer btnzobaczImie'></form></td>
							<td> 
							<div class='editionbar'>
								<div id='s$nr' class='wrapper'> 
								<a href='#s$nrS'> opcje </a>
									<ul>
										<li><form action='edytujFirme.php' method='post'><input type='hidden' value=".$id_firmy." name='inputIdFirmy'><input type ='submit' name='edytujFirme' value='edytuj' class='btnedit pointer'></form></li>
										<li><button onclick='okienkoDelete2($id_firmy)' class='btnedit pointer'> usuń </button></li>
									</ul>
								</div>
							</div>
							</td>
