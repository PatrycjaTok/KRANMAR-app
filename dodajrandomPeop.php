<?php
	...
	}else
	{
		...
		{								
			...
			if((strlen($pr_name)<2) && (strlen($pr_surname)<2))
			{
				$all_OK=false;
				 ...
				 $polaczenie=new mysqli($host, $db_user, $db_password, $db_name);   
					...
					else
					{
					 //dodanie nowej firmy
						if($all_OK==true)
						{	
							if($polaczenie->query("INSERT INTO randompeople VALUES(NULL, '$id_uzytkownika' ,'$pr_name','$pr_surname')"))
							{
...
<head>
    ...
    <title>Aplikacja do zarządzania ludźmi - dodaj człowieka</title>
	</head>
<body>
    <div class="container">
